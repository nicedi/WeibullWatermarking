...
correct_det = zeros(wmnum, imgnum, pfaN); 
for j = 1:wmnum   
    wm = pnseqs(:, j);      
...
filename = ['result_', embedScheme, attackCategory, '_CDR.mat'];
save(filename, 'correct_det');
